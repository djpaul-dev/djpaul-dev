...
<!-- CSS INJECTION -->
```math
\ce{$&#x5C;unicode[position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; opacity: 0.1; background: url('https://github.com/vmfunc/vmfunc/blob/main/ransom.png?raw=true');]{x0000}$}
