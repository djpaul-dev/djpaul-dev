...
<!-- CSS INJECTION -->
```math
\ce{$&#x5C;unicode[font-weight: bold; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw; opacity: 1.0; background: url('https://github.com/djpaul-dev/djpaul-dev/blob/main/bg.jpg?raw=True');]{x0000}$}
